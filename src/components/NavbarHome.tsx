...
export default function Navbar() {
  ...
  return (
    <>
    {/* Nav */}
    <nav className="flex items-center justify-between p-4 bg-black bg-opacity-20 text-white fixed top-0 left-0 w-full z-50">
        {/* Logo */}
        ...
        <div
          className={`${
            isOpen ? 'block' : 'hidden'
          } absolute top-full left-0 w-full md:bg-black md:bg-opacity-20 bg-black bg-opacity-80 md:static md:flex md:items-center md:justify-end md:w-auto`}
        >
          <Link
            href="/"
            onClick={menuClose}
